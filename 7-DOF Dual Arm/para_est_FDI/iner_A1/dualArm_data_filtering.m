...
Ts = t(2)-t(1);
fs = 1/Ts;
% Wp = 20/(fs/2);     %Stopband corner frequency Ws, 1 corresponding to the normalized Nyquist frequency
% Ws = 40/(fs/2);    %Passband corner frequency Wp, normalized via dividing by nyquist frequency fs/2;
% Rp = 3;             %Passband ripple in decibels
% Rs = 60;            %Stopband attenuation in decibels. This value is the number of decibels the stopband is down from the passband.
